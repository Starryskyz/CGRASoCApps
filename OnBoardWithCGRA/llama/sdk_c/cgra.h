...
void mmpartwithinputKeep(XAxiCdma* AxiCdmaInstance, XScuGic* IntcController, void* arg_0, void* arg_1, void* arg_2){
  int Status;
  int16_t *SrcPtr, *DesPtr;
...
void matmulCGRA(XAxiCdma* AxiCdmaInstance, XScuGic* IntcController, float* arg_0, float* arg_1, float* arg_2, int callnum) {
    mmpart(AxiCdmaInstance, IntcController, (void*)arg_0, (void*)arg_1, (void*)arg_2);

    for(int i = 1; i < callnum; i++) {
        float* addr_1 = arg_1 + 8192 * i;
        float* addr_2 = arg_2 + 16 * i;
        mmpartwithinputKeep(AxiCdmaInstance, IntcController, (void*)arg_0, (void*)addr_1, (void*)addr_2);
    }
}


void matmulCGRA2(XAxiCdma* AxiCdmaInstance, XScuGic* IntcController, float* arg_0, float* arg_1, float* arg_2, int callnum) {


    for(int i = 0; i < callnum; i++) {
        float* addr_1 = arg_1 + 8192 * i;
        float* addr_2 = arg_2 + 16 * i;
        mmpart(AxiCdmaInstance, IntcController, (void*)arg_0, (void*)addr_1, (void*)addr_2);
    }
}
